...
class TestFizz(unittest.TestCase) :
    ...
    def testPlayLargeNumber(self):
        ...
        self.assertEqual(self.game.play("2000300624103679337202883934330700182830667"), self.game.name, 'incorrect reponse for 2000300624103679337202883934330700182830667')
